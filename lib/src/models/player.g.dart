...
OutputProtocol _$OutputProtocolFromJson(Map<String, dynamic> json) =>
    OutputProtocol()
...
Map<String, dynamic> _$OutputProtocolToJson(OutputProtocol instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$DeviceInfoToJson(DeviceInfo instance) =>
    <String, dynamic>{
      ...
      'identifiers': instance.identifiers
          .map((k, e) => MapEntry(_$IdentifierTypeEnumMap[k]!, e)),
    };
...
Map<String, dynamic> _$PlayerSourceToJson(PlayerSource instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
PlayerSoundMode _$PlayerSoundModeFromJson(Map<String, dynamic> json) =>
    PlayerSoundMode()
      ..id = json['id'] as String?
      ..name = json['name'] as String?
      ..passive = json['passive'] as bool
...
Map<String, dynamic> _$PlayerSoundModeToJson(PlayerSoundMode instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'passive': instance.passive,
...
PlayerOptionEntry _$PlayerOptionEntryFromJson(Map<String, dynamic> json) =>
    PlayerOptionEntry()
...
Map<String, dynamic> _$PlayerOptionEntryToJson(PlayerOptionEntry instance) =>
    <String, dynamic>{
      'key': instance.key,
      'name': instance.name,
...
PlayerOption _$PlayerOptionFromJson(Map<String, dynamic> json) => PlayerOption()
  ...
  ..type = $enumDecodeNullable(_$PlayerOptionTypeEnumMap, json['type'])
  ..translationKey = json['translation_key'] as String
  ..translationParams = (json['translation_params'] as List<dynamic>?)
      ?.map((e) => e as String)
      .toList()
  ..value = json['value']
...
Map<String, dynamic> _$PlayerOptionToJson(PlayerOption instance) =>
    <String, dynamic>{
      'key': instance.key,
      'name': instance.name,
      'type': _$PlayerOptionTypeEnumMap[instance.type],
...
Player _$PlayerFromJson(Map<String, dynamic> json) => Player()
  ...
  ..groupMembers =
      (json['group_members'] as List<dynamic>).map((e) => e as String).toList()
  ..staticGroupMembers = (json['static_group_members'] as List<dynamic>)
      .map((e) => e as String)
      .toList()
  ..canGroupWith =
      (json['can_group_with'] as List<dynamic>).map((e) => e as String).toSet()
  ...
  ..soundModeList = (json['sound_mode_list'] as List<dynamic>)
      ...
      .toList()
  ..options = (json['options'] as List<dynamic>)
      .map((e) => PlayerOption.fromJson(e as Map<String, dynamic>))
      .toList()
...
Map<String, dynamic> _$PlayerToJson(Player instance) => <String, dynamic>{
      ...
      'supported_features': instance.supportedFeatures
          .map((e) => _$PlayerFeatureEnumMap[e]!)
          .toList(),

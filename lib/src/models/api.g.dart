...
ServerInfoMessage _$ServerInfoMessageFromJson(Map<String, dynamic> json) =>
    ServerInfoMessage()
      ..serverId = json['server_id'] as String
      ..serverVersion = json['server_version'] as String
      ..schemaVersion = (json['schema_version'] as num).toInt()
      ..minSupportedSchemaVersion =
          (json['min_supported_schema_version'] as num).toInt()
...
Map<String, dynamic> _$ServerInfoMessageToJson(ServerInfoMessage instance) =>
    <String, dynamic>{

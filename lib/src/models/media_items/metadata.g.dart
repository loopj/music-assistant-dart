...
Map<String, dynamic> _$MediaItemPaletteToJson(MediaItemPalette instance) => <String, dynamic>{
      ...
      'primary': instance.primary == null
          ? null
          : <String, dynamic>{
              r'$1': instance.primary!.$1,
              r'$2': instance.primary!.$2,
              r'$3': instance.primary!.$3,
            },
      'accent': instance.accent == null
          ? null
          : <String, dynamic>{
              r'$1': instance.accent!.$1,
              r'$2': instance.accent!.$2,
              r'$3': instance.accent!.$3,
            },
      'on_dark': instance.onDark == null
          ? null
          : <String, dynamic>{
              r'$1': instance.onDark!.$1,
              r'$2': instance.onDark!.$2,
              r'$3': instance.onDark!.$3,
            },
      'on_light': instance.onLight == null
          ? null
          : <String, dynamic>{
              r'$1': instance.onLight!.$1,
              r'$2': instance.onLight!.$2,
              r'$3': instance.onLight!.$3,
            },
    };

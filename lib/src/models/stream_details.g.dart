...
MultiPartPath _$MultiPartPathFromJson(Map<String, dynamic> json) =>
    MultiPartPath()
      ..path = json['path'] as String?
      ..duration = (json['duration'] as num?)?.toDouble();

Map<String, dynamic> _$MultiPartPathToJson(MultiPartPath instance) =>
    <String, dynamic>{
      'path': instance.path,
      'duration': instance.duration,
    };
...
StreamDetails _$StreamDetailsFromJson(Map<String, dynamic> json) =>
    StreamDetails()
      ...
      ..streamType =
          $enumDecodeNullable(_$StreamTypeEnumMap, json['stream_type'])
      ..duration = (json['duration'] as num?)?.toInt()
      ..size = (json['size'] as num?)?.toInt()
      ..streamMetadata = json['stream_metadata'] == null
          ? null
          : StreamMetadata.fromJson(
              json['stream_metadata'] as Map<String, dynamic>);
